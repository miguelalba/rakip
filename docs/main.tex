...
\R Product | Product | 0 | *
\R Hazard | Hazard | 0 | *
\R PopulationGroup | PopulationGroup | 0 | *
\R GeneralComment | string | 0 | 1
\R TemporalInformation | string | 0 || 1
\R SpatialInformation | SpatialInformation | 0 | 1
\stoptable
...
\starttable
    \R Study | Study | 0 | 1
    \R StudySample | StudySample | 0 | *
    \R DietaryAssessmentMethod | DietaryAssessmentMethod | 0 | *
    \R Laboratory | Laboratory | 0 | *
    \R Assay | Assay | 0 | *
\stoptable
...
\starttable
    \R Parameter | Parameter | 1 | *
    \R QualityMeasures | QualityMeasures | 0 | 1
